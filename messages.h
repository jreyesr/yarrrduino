...
#define BPMSG1067 bp_message_write_buffer_progmem(F("Set speed:\r\n 1. 100KHz\r\n 2. 400KHz\r\n 3. 1MHz"))
#define BPMSG1068 bp_message_write_buffer_progmem(F("I2C (mod spd)=( "))
#define BPMSG1069 bp_message_write_buffer_progmem(F(" 0.Macro menu\r\n 1.7bit address search\r\n 2.I2C sniffer"))
#define BPMSG1070 bp_message_write_line_progmem(F("Searching I2C address space. Found devices at:"))
...
#define MSG_ACK bp_message_write_buffer_progmem(F("ACK"))
...
#define MSG_I2C_READ_ADDRESS_END bp_message_write_buffer_progmem(F(" R) "))
...
#define MSG_I2C_WRITE_ADDRESS_END bp_message_write_buffer_progmem(F(" W) "))
#define MSG_MODE_HEADER_END	bp_message_write_line_progmem(F(" )"))
#define MSG_NACK bp_message_write_buffer_progmem(F("NACK"))
...
#define MSG_SNIFFER_MESSAGE bp_message_write_line_progmem(F("Sniffer"))
...
#define MSG_WARNING_HEADER bp_message_write_buffer_progmem(F("Warning: "))
#define MSG_WARNING_SHORT_OR_NO_PULLUP bp_message_write_buffer_progmem(F("*Short or no pull-up "))
